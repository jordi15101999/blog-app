                        ...
                        <div class="table-responsive">
                            <table class="table table-dark table-striped table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td width="20px"><div v-on:click="deleteCategory(category.id)" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></div></td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
                        <pagination class="pagination" v-if="pagination.last_page > 1" :pagination="pagination" :offset="5" @paginate="getCategories()"></pagination>
                    </div>    
                </div>
			</div>
    </div>
