			...
			<div class="container-fluid">
        		<div class="table-responsive">
					<table class="table table-dark table-striped table-bordered">
						...
						<tbody class="text-center" v-for="post in posts" v-bind:key="post.id" v-bind:value="post.id">
						<tr>
							<td>{{post.title}}</td>
							<td><img style="width:200px;height:100px;" :src="'/uploads/' + post.image"></td>
							...
							<td width="20px"><div class="btn btn-sm btn-danger" v-on:click="deletePost(post.id)"><i class="fa fa-trash"></i></div></td>
						</tr>
						</tbody>
					</table>
